package quotes.dealmedan2.view.activity;
...
import quotes.dealmedan2.model.session.SessionManager;
import quotes.dealmedan2.view.fragment.user.UserASC;
import quotes.dealmedan2.view.fragment.viewpager.viewpager;
...
public class MainActivity extends ParentActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        this.changefragment(new viewpager());
        this.setTitle("User");
    }
